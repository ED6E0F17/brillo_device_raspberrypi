...
#define LOG_TAG "wifi_hal_rtl8192cu"
 ...
 */
static wifi_driver_error wifi_driver_initialize_rtl8192cu(void) {
    return WIFI_SUCCESS;
}

static wifi_driver_error wifi_driver_initialize_rtl8192cu_internal(void) {
    struct ifreq req;
    int rc, socketfd;
...
static wifi_driver_error wifi_driver_set_mode_rtl8192cu(
    ...
    return wifi_driver_initialize_rtl8192cu_internal();
}

static int
close_rtl8192cu_driver(struct hw_device_t *device) {
...
static int
open_rtl8192cu_driver(const struct hw_module_t* module, const char*, struct hw_device_t** device) {
    ...
    dev->common.close = close_rtl8192cu_driver;
    dev->wifi_driver_initialize = wifi_driver_initialize_rtl8192cu;
    dev->wifi_driver_set_mode = wifi_driver_set_mode_rtl8192cu;
...
static struct hw_module_methods_t rtl8192cu_driver_module_methods = {
    .open = open_rtl8192cu_driver
};
...
struct hw_module_t HAL_MODULE_INFO_SYM = {
    ...
    .name          = "RTL8192CU module",
    .author        = "Intel",
    .methods       = &rtl8192cu_driver_module_methods,
    .dso           = NULL,
    .reserved      = {0},
};
