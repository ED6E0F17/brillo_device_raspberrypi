...
$(KERNEL_CONFIG): $(KERNEL_OUT)
	$(hide) cp device/rpi/gert/kernel.config $(KERNEL_OUT)/.config
...
$(KERNEL_BIN): $(KERNEL_OUT) $(KERNEL_CONFIG)
	...
	$(hide) cp $(KERNEL_OUT)/arch/arm/boot/dts/bcm27* $(PRODUCT_OUT)/boot
	...
	$(hide) cp device/rpi/gert/bsp/cmdline.txt $(PRODUCT_OUT)/boot
